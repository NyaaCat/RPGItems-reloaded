...
The development branch is `1.11.2` version 3.6 and is in *earlier development stage*. 

The active branch is `1.11` version 3.5 and the work is focused on fixing bugs and compatibility issues resolving.  
