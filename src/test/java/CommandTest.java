...
public class CommandTest {
  ...
  public void before() {
    ...
    // ServerLoadEvent(ServerLoadEvent.LoadType.STARTUP));
  ...
  class MetaTests {
    ...
    private void testQuality() {
      ...
      Assert.assertEquals(
          is2.getItemMeta().getDisplayName(), HexColorUtils.hexColored("&btestVanilla"));
      Assert.assertEquals(
          is3.getItemMeta().getDisplayName(), HexColorUtils.hexColored("&e&6testVanilla"));
      ...
      Assert.assertEquals(
          is2.getItemMeta().getDisplayName(),
          HexColorUtils.hexColored("&b&cDesert Eagle | PrintStream"));
    }
  }
}
