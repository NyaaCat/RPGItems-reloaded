...
public class Selector extends BaseMarker {
  ...
  /**
   * X-coordinate of reference position, tilde notation is available. Use player's current position
   * if empty
   */
  @Property public String x;
  /**
   * Y-coordinate of reference position, tilde notation is available. Use player's current position
   * if empty
   */
  @Property public String y;
  /**
   * Z-coordinate of reference position, tilde notation is available. Use player's current position
   * if empty
   */
  ...
  public void inPlaceFilter(Player p, List<Entity> entities) {
    ...
    List<Entity> ents =
        entities.stream()
            .filter(entity -> !Utils.isUtilArmorStand(entity) && inRadius(entity, ref, r, rm))
