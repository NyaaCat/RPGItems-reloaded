...
public class ParticleBarrier extends BasePower {
      ...
      event =
          new Listener() {
            ...
            public void onEntityDamage(EntityDamageEvent entityDamageEvent) {
              ...
              double energyGain =
                  Math.min(
                      getEnergyPerBarrier(), damage * getEnergyPerBarrier() / getBarrierHealth());
              ...
              double energy =
                  currentEnergy - (currentTime - lastTime) * getEnergyDecay() / 1000 + energyGain;
  ...
  public static class Impl
    ...
    public PowerResult<Void> tick(ParticleBarrier power, Player player, ItemStack stack) {
      ...
      double energy =
          pair.getValue() - (currentTimeMillis - pair.getKey()) * power.getEnergyDecay() / 1000;
