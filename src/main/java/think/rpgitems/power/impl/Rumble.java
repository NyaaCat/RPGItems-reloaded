                        ...
                        public void run() {
                            ...
                            for (int x = -2; x <= 2; x++) {
                                for (int z = -2; z <= 2; z++) {
                                    ...
                                    temp.getWorld()
                                            .playEffect(temp, Effect.STEP_SOUND, block.getType());
                                }
                            }
                            ...
                            if (hit) {
                                near =
                                        getNearbyEntities(
                                                power, location, player, power.getPower() * 2 + 1);
                                for (Entity e : near) {
                                    if (e != player) {
                                        if (e instanceof ItemFrame || e instanceof Painting) {
                                            e.setMetadata(
                                                    ...
                                                    new FixedMetadataValue(
                                                            RPGItems.plugin,
                                                            null)); // Add metadata to protect
                                            // hanging entities from the
                                            // explosion
                                            continue;
                                        }
                                ...
                                location.getWorld()
                                        .createExplosion(
                                                ...
                                                power.getPower(),
                                                false,
                                                false); // Trigger the explosion after all hanging
                                // entities have been
                                // protected
                                cancel();
                                return;
