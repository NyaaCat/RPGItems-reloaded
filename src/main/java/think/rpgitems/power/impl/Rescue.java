    ...
    public static class Impl implements PowerHurt<Rescue>, PowerHitTaken<Rescue> {
        ...
        private PowerResult<Double> rescue(
            ...
            target.addPotionEffect(
                    new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 200, 10), true);
            ...
            target.getWorld()
                    .playSound(target.getLocation(), Sound.BLOCK_ENCHANTMENT_TABLE_USE, 10, 1);
        ...
        public PowerResult<Double> takeHit(
                ...
                EntityDamageEvent event) {
            double health = target.getHealth() - event.getFinalDamage();
            if (health > power.getHealthTrigger()
                    && event.getFinalDamage() < power.getDamageTrigger()) return PowerResult.noop();
