    ...
    public PowerResult<Void> fire(Ice power, Player player, ItemStack stack) {
      ...
      final FallingBlock block =
          player
              .getWorld()
              .spawnFallingBlock(
                  player.getLocation().add(0, 1.8, 0), Material.PACKED_ICE.createBlockData());
                    ...
                    for (int z = -1; z < 2; z++) {
                      ...
                      if (!b.getType().isSolid()
                          && !(b.getType() == Material.PLAYER_HEAD
                              || b.getType() == Material.PLAYER_WALL_HEAD)) {
                ...
                (new BukkitRunnable() {
                      ...
                      public void run() {
                        for (int i = 0; i < 4; i++) {
                          ...
                          Location position =
                              changedBlocks.keySet().toArray(new Location[0])[index];
