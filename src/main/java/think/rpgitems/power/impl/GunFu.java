...
public class GunFu extends BasePower {
    ...
    @Property public double viewAngle = 30;

    @Property public double initVelFactor = 0.5;

    @Property public double velFactor = 0.05;

    @Property public double forceFactor = 1.5;

    @Property public int maxTicks = 200;
    ...
    public static class Impl implements PowerProjectileLaunch<GunFu>, PowerBowShoot<GunFu> {
        ...
        public PowerResult<Float> bowShoot(
                GunFu power, Player player, ItemStack stack, EntityShootBowEvent event) {
        ...
        public PowerResult<Float> run(
                GunFu power, Player player, Projectile projectile, float force) {
            ...
            if (!entities.isEmpty()) {
                ...
                Context.instance()
                        .putExpiringSeconds(player.getUniqueId(), "gunfu.target", target, 3);
                new BukkitRunnable() {
        ...
        @Override
        public PowerResult<Void> projectileLaunch(
                GunFu power, Player player, ItemStack stack, ProjectileLaunchEvent event) {
