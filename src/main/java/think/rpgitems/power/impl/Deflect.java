    ...
    public static class Impl
        ...
        public PowerResult<Double> takeHit(
            ...
            boolean activated =
                    System.currentTimeMillis() / 50
                            < getTime().getOrDefault(target.getUniqueId(), 0L);
            ...
            if (getAngleBetweenVectors(
                                    target.getEyeLocation().getDirection(),
                                    relativePosition.multiply(-1))
                            < power.getFacing()
                    && (p instanceof SmallFireball
                            || p instanceof LargeFireball
                            || p instanceof Arrow)) {
                ...
                if (p instanceof TippedArrow) {
                    ...
                    tippedArrowP
                            ...
                            .forEach(
                                    potionEffect ->
                                            tippedArrowT.addCustomEffect(potionEffect, true));
                }
                ...
                if (p instanceof Trident) {
                    ...
                    TridentUtils.setTridentItemStack(
                            tridentP, TridentUtils.getTridentItemStack(tridentT));
                }
        ...
        public PowerResult<Void> fire(Deflect power, Player player, ItemStack stack) {
            getTime()
                    .put(
                            player.getUniqueId(),
                            System.currentTimeMillis() / 50 + power.getDuration());
