            ...
            try {
                ...
                ex.and("damage", BigDecimal.valueOf(damage))
                        ...
                        .and(
                                ...
                                byProjectile ? BigDecimal.ONE : BigDecimal.ZERO)
                        .and(
                                "damagerTicksLived",
                        ...
                        .and(
                                "playerYaw",
                                Utils.lazyNumber(() -> (double) player.getLocation().getYaw()))
                        .and(
                                "playerPitch",
                ...
                RPGItems.plugin
                        .getLogger()
                        .log(Level.WARNING, "bad expression: " + power.getExpression(), ex);
                ...
                if (byEntity) {
                    ...
                    ex.and("damagerType", damager.getType().name())
                            ...
                            .and(
                                    "entityPitch",
                                    Utils.lazyNumber(
                                            () -> (double) entity.getLocation().getPitch()))
                            .and("entityX", Utils.lazyNumber(() -> entity.getLocation().getX()))
                            .and("entityY", Utils.lazyNumber(() -> entity.getLocation().getY()))
                            .and("entityZ", Utils.lazyNumber(() -> entity.getLocation().getZ()));
                }
