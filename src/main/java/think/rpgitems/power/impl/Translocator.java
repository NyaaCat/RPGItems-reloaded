...
public class Translocator extends BasePower {
  ...
  public static class Impl
    ...
    public PowerResult<Boolean> swapToMainhand(
        Translocator power, Player player, ItemStack stack, PlayerSwapHandItemsEvent event) {
    ...
    public PowerResult<Boolean> swapToOffhand(
      ...
      SpectralArrow arrow =
          player.launchProjectile(
              SpectralArrow.class, player.getLocation().getDirection().multiply(power.getSpeed()));
