...
public class PowerAttract extends BasePower {
    ...
    public void setAttractingEntityTickCost(int attractingEntityTickCost) {
        this.attractingEntityTickCost = attractingEntityTickCost;
    }

    public void setAttractingTickCost(int attractingTickCost) {
        this.attractingTickCost = attractingTickCost;
    }
