...
public class PlayerRPGInventoryCache {
    ...
    private CachedPlayerInventory buildCache(Player player) {
        ...
        for (int i = 0; i < inventory.length; i++) {
            ...
            Optional<RPGItem> rpgItem = ItemManager.toRuntimeRPGItem(stack);
        ...
        Optional<RPGItem> mainHandRPG = ItemManager.toRuntimeRPGItem(mainHand);
        ...
        Optional<RPGItem> offHandRPG = ItemManager.toRuntimeRPGItem(offHand);
