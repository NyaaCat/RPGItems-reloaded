...
public final class ItemTagUtils {
    ...
    public static Optional<Boolean> optBoolean(
    ...
    public static SubItemTagContainer makeTag(
            PersistentDataContainer container, NamespacedKey key) {
                    ...
                    public void finalizeReferent() {
                        if (SubItemTagContainer.references.remove(this)) {
                            RPGItems.logger.severe(
                                    "Unhandled SubItemTagContainer found: "
                                            + key
                                            + "@"
                                            + weakParent.get());
                        }
    ...
    public static class ItemStackPersistentDataType
    ...
    public static class SubItemTagContainer implements PersistentDataContainer {
        ...
        public <T, Z> Z getOrDefault(
                NamespacedKey key, PersistentDataType<T, Z> type, Z defaultValue) {
        ...
        public void dispose() {
            ...
            if (!SubItemTagContainer.references.remove(reference)) {
                RPGItems.logger.log(
                        Level.SEVERE,
                        "Double handled SubItemTagContainer found: "
                                + this
                                + ": "
                                + key
                                + "@"
